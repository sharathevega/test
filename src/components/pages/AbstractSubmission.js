        ...
        <div>
            ...
            <div class="brand_wrap">
                <div class="auto-container">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="https://nursing-meetings.com/development">Home</a> <i class="fa fa-angle-right"></i>
                    ...
                    <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12 mar_lk55">
                                        <div class="upload_wrap15 col-lg-6 pd0">
                                            ...
                                            <span class="back_wrapblue"><input name="upload_abstract_file" class="abck155"
                        ...
                        <div class="col-md-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="sq_abmainbox">
                                ...
                                <span class="map_l55 sq_map"><img src={map} alt="Nursing Global Conference" />
