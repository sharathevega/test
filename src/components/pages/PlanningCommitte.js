        ...
        <div>
            ...
            <div class="brand_wrap">
                <div class="auto-container">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="https://nursing-meetings.com/development">Home</a> <i class="fa fa-angle-right"></i> <span>Planning Committee</span>
                        </div>
                    </div>
                </div>
            </div>

            <h1 class="abs_wrap5 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">Planning Committee</h1>
...
export default PlanningCommitte