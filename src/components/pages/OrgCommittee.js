        ...
        <div>
            ...
            <div class="brand_wrap">
                <div class="auto-container">
                    <div class="row">
                        <div class="col-md-12">
                            <Link to="/">Home</Link> <i class="fa fa-angle-right"></i> <span>Organizing Committee</span>
                        </div>
                    </div>
                </div>
            </div>

            <h1 class="abs_wrap5 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">Organizing Committee</h1>
