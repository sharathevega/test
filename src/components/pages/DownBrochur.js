...
const DownBrochur = () => {
    return (
        <div>
            ...
            <h1 class="abs_wrap5 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">Download Brochure</h1>
                ...
                <div class="auto-container">
                    <div class="row clearfix wow fadeInUp justify-content-center" style={{display:"flex",justifyContent:"center"}} data-wow-delay="400ms" data-wow-duration="1000ms"
                        ...
                        <div class="col-md-8 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                            ...
                            <form action="" method="post" class="" id="brocherDownloadForm">
                                <div class="row clearfix">
                                    <div class="col-md-6 left15">
                                        <label>Name <span>*</span></label>
                                        <input name="name" class="set157" id="name" placeholder="Name" type="text" required />
                                        <div class="error" id="name_error"></div>
                                    </div>
                                    <div class="col-md-6 left16">
                                        <label>Email <span>*</span></label>
                                        <input name="email" id="email" class="set157" placeholder="Email" type="text"
                                            required />
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6 left15">
                                        ...
                                        <input name="phone" id="phone" class="set157" placeholder="Phone" type="text"
                                            required />
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12 set_lab575">
                                        ...
                                        <textarea name="message" id="message" class="set158"
                                        ...
                                        <div class="col-md-12 mar_lk55">
                                            <div class="col-md-6">
                                                <div class="g-recaptcha"
                                                    data-sitekey="6Lfk8wAqAAAAAPbKxIjt1Ady_rZoXHPc5R0qFZvX"
                                                    data-action="LOGIN">
                                                </div>
                                            </div>
                                            <div class="bt_add156">
                                                <button onclick="submitdownbrocher();" type="button" class="bt_nmk6"
                                ...
                                <Link href="fdownload.php" id="downloadpdf" class="hide">download</Link>
